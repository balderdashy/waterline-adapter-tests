  ...
  describe('Sub Attribute Query Modifier', function() {
    ...
    describe('lessThan (<, <=)', function() {
      ...
      it('should return records with lessThan key', function(done) {
        User.findAll({ first_name: testName, age: { lessThan: 42 }}, function(err, users) {
          assert(!err);
      ...
      it('should return records with symbolic usage < usage', function(done) {
        User.findAll({ first_name: testName, age: { '<': 42 }}, function(err, users) {
          assert(!err);
          assert(Array.isArray(users));
          assert(users.length === 2);
          assert(users[0].age === 40);
      ...
      it('should return records with lessThanOrEqual key', function(done) {
        User.findAll({ first_name: testName, age: { lessThanOrEqual: 42 }}, function(err, users) {
          assert(!err);
          assert(Array.isArray(users));
    ...
    describe('greaterThan (>, >=)', function() {
      ...
      it('should return records with greaterThan key', function(done) {
        User.findAll({ first_name: testName, age: { greaterThan: 40 }}, function(err, users) {
          assert(!err);
          assert(Array.isArray(users));
          assert(users.length === 3);
      ...
      it('should return records with symbolic usage > usage', function(done) {
        User.findAll({ first_name: testName, age: { '>': 40 }}, function(err, users) {
          assert(!err);
          assert(Array.isArray(users));
          assert(users.length === 3);
          assert(users[0].age === 41);
      ...
      it('should return records with greaterThanOrEqual key', function(done) {
        User.findAll({ first_name: testName, age: { greaterThanOrEqual: 41 }}, function(err, users) {
          assert(!err);
          assert(Array.isArray(users));
          assert(users.length === 3);
          assert(users[0].age === 41);
      ...
      it('should return records with symbolic usage >= usage', function(done) {
        User.findAll({ first_name: testName, age: { '>=': 41 }}, function(err, users) {
          assert(!err);
          assert(Array.isArray(users));
          assert(users.length === 3);
          assert(users[0].age === 41);
    ...
    describe('not (!)', function() {
      ...
      it('should return records with string usage', function(done) {
        User.findAll({ first_name: testName, age: { not: 40 }}, function(err, users) {
          assert(!err);
          assert(Array.isArray(users));
          assert(users.length === 3);
          assert(users[0].age === 41);
